...
class PostActivityServerWithCoroutine3 : AppCompatActivity(){
            ...
            commentRecyclerAdapter.submitList(modelList)
                if(index == 2){
                    binding.rcvComment.apply {
                        layoutManager = LinearLayoutManager(this@PostActivityServerWithCoroutine3, LinearLayoutManager.VERTICAL, false)
